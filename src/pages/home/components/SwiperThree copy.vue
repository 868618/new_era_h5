...
const hatRecommend = computed<{
  ...
  console.log("props: xxxx nnnnnnnnnnn ", props.data)
...
const currentHat = computed(() => hatRecommend.value[status.value.activeIndex])
</script>
    ...
    <div class="w-623px h-1060px  mx-auto bg-[url(@@/assets/images/subpage-bg.png)] bg-cover bg-no-repeat px-35px relative mt-42px">
      ...
      <section class="mt-36px">
        ...
        <div class="w-335px h-71px box-border mx-auto flex items-center justify-center bg-[url(@@/assets/images/hat-detail-head-bg.png)] bg-contain bg-no-repeat">
          <p class="text-center">
            <b class="text-22px font-[SourceHanSansCN-Medium] text-#FFF font-900">匹配度</b> <span class="text-#000 text-27px font-[AliHYAiHei] ml-7px">{{ hatRecommend[status.activeIndex].score }}%</span>
          </p>
        </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <img :src="status.currentImg || item.images[0]" class="w-209px inline-block">
                </div>
              </SwiperSlide>
            </Swiper>
